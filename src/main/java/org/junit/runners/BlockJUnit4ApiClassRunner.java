...
import junit.apiFramework.server.JettyServerFactory;
import org.junit.*;
 ...
 * @since 4.5
 */
public class BlockJUnit4ApiClassRunner extends ParentRunner<FrameworkMethod> {
     ...
     */
    public BlockJUnit4ApiClassRunner(Class<?> testClass) throws InitializationError {
        super(testClass);
    }
     ...
     * @since 4.13
     */
    protected BlockJUnit4ApiClassRunner(TestClass testClass) throws InitializationError {
        super(testClass);
    }
    ...
    protected Statement methodBlock(final FrameworkMethod method) {
        ...
        statement=withTestApis(method, test, statement);

        return statement;
    }

    protected Statement withTestApis(FrameworkMethod method, Object target,
                                      Statement statement){
       ...
       try {
           ...
           Runnable r=new Runnable() {
               @Override
               public void run() {
                   JettyServerFactory.createWebAppServer();
               }
           };
           ...
           TestApis testApis=method.getAnnotation(junit.apiFramework.TestApis.class);
           TestApi []  listOfAPToBeInvoked=testApis.value();

          // new InvokeApis(method,target).evaluate();
       }
       catch (Throwable e){
    ...
    protected Statement methodInvoker(FrameworkMethod method, Object test) {
        return new InvokeApiMethodAndApis(method, test);
    }
